 ...
 \noindent o en forma de árbol:
  ...
  & & & & &  &  Abs &  & & & & & & & & &\\\\
   ...
   En el siguiente paso, el nodo que analizamos es también una abstracción, por lo tanto repetimos el mismo procedimiento:
    ...
    & & & & & \ar@{-->}@/_-0.3pc/[dddd] & \ar[dddd]^{f} Abs & \ar@{<--}@/_0.3pc/[dddd] & & & & & & & & &\\
    & & & \df{\pi_f = f:\theta_1} & & &  & & 
    		\dfH{TS = \{\theta_0:=\theta_1 \rightarrow \theta_3 \rightarrow \theta_4,} & & & & & & & &\\
    & & & \df{t = \theta_2} & & &  & & \;\;\;\;\;\;\;\;\;\;
    		\dfH{\theta_2 := \theta_3 \rightarrow \theta_4\} \bigcup\,\{?\}} & & & & & & & &\\
    & & & & & &  & & & & & & & & & &\\
    & & & & & \ar@{-->}@/_-0.3pc/[dddd] & \ar[dddd]^{x} Abs & \ar@{<--}@/_0.3pc/[dddd] & & & & & & & & &\\
    & & & \dfH{\pi_{f,x} = \pi_f,\,x:\theta_3} & & &  & & & & & & & & & &\\
  ...
  \xymatrix @C=0.1pc @R=0.3pc{
    & & & & & \ar@{-->}@/_-0.3pc/[dddd] & \ar[dddd]^{f} Abs & \ar@{<--}@/_0.3pc/[dddd] & & & & & & & & &\\
    & & & \df{\pi_f = f:\theta_1} & & &  & & \df{TS = \{\theta_0	:=\theta_1 \rightarrow \theta_3 \rightarrow \theta_4,} & & & & & & & &\\
    & & & \df{t = \theta_2} & & &  & & \;\;\;\;\;\;\;\;\;\;\df{\theta_2 := \theta_3 \rightarrow \theta_4\} \bigcup\,\{?\}} & & & & & & & &\\
    & & & & & &  & & & & & & & & & &\\
    & & & & & \ar@{-->}@/_-0.3pc/[dddd] & \ar[dddd]^{x} Abs & \ar@{<--}@/_0.3pc/[dddd] & & & & & & & & &\\
    & & & \df{\pi_{f,x} = \pi_f,\,x:\theta_3} & & &  & & & & & & & & & &\\
  ...
  procedimiento:
    ...
    & & & \df{\pi_{f,x} = \pi_f,\,x:\theta_3} & & &  & & & & & & & & & &\\
    & & & \df{t = \theta_4} & & &  & & 
    	  \df{TS = \{\theta_2:=\theta_3 \rightarrow \theta_4,} & & & & & & & &\\
    & & & & & &  & & 
    	  \;\;\;\;\;\;\;\;\;\;\;\;\df{\theta_1:=\theta_5 \rightarrow \theta_6,}& & & & & & & &\\
  & & & & & \ar@{-->}@/_-0.3pc/[dddddlll]!<7ex,0ex> \ar@{-->}@/_0.7pc/[dddddrrr]!<-2ex,0ex> &
											  \ar[dddddlll] App \ar[dddddrr] & 
		    \ar@{<--}@/_-0.6pc/[dddddllll]!<2ex,0ex>
		    \ar@{<--}@/_0.7pc/[dddddr]!<15ex,-10ex> &
		    \df{\theta_5:=\theta_6, \theta_4	:=\theta_5, \theta_3:=\theta_6\}} & & & & & & & &\\
  & & & \df{\pi_{f,x}} & & & \df{\pi_{f,x}}  & & & & & & & & & &\\
  & & & \df{t = \theta_5 \rightarrow \theta_4} & & & \df{t = \theta_5} & &
  		\df{TS = \{\theta_1:\theta_6 \rightarrow \theta_5, \theta_3:\theta_6\}} & & & & & & & &\\
  & & & & & &   \df{TS = \{\theta_1:\theta_5 \rightarrow \theta_4\}} & & & & & & & & & &\\
  & & & & & &   & & & & & & & & & &\\
& & & f & & &   & & \ar@{-->}@/_1.4pc/[ddddd]!<-20ex,-10ex>
					\ar@{-->}@/_1.4pc/[dddddrr]
					\ar[dddddl] App \ar[dddddrr]
					\ar@{<--}@/_-1pc/[dddddrr]!<2ex,0ex>
					\ar@{<--}@/_-1pc/[dddddl]!<1ex,1ex>
					& & & & & & & &\\
& & & & & & \dfH{\pi_{f,x}} & & \dfH{\pi_{f,x}} & & & & & & & & \\
& & & & & & \dfH{t = \theta_6 \rightarrow \theta_5} 
			& & \dfH{t = \theta_6} & & & 
			\dfH{TS = \{\theta_3:\theta_6\}} & & & & & \\
& & & & & & & & \dfH{TS = \{\theta_1:\theta_6 \rightarrow \theta_5\}} &   & & & & & & & \\
& & & & & &   & & & & & & & & & &\\
& & & & & &   & f & & & x & & & & & &\\
}
